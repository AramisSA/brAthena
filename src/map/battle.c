...
******************************************************************************
* src/map/battle.c                                                           *
* C�lculo de f�rmulas de batalha do emulador                                 *
******************************************************************************
...
// eAthena additions
	 ...
	 * brAthena
	 **/
	// Configura��o para a habilidade de revestimento dos criadores e alquimistas. [CarlosHenrq]
	{ "creator.fullprotect",				&battle_config.creator_fullprotect,				0,		0,		2,				},
	// Configura��o para bloquear jogadores de abrir chat/vendas na mesma celula. [CarlosHenrq]
	...
	// Configura��o para habilidades de remover armas. [Sir Will]
